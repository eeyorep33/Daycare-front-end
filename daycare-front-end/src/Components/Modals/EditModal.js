...
let currentAdmin = ''
  if(props.index !== null && props.index !== '') {
      ...
      if(props.type === "Classroom" || props.type === "Announcement") {
        name = props.name      }
if(props.type ==="Employee" || props.type === "Student" || props.type === "Profile") {
  label = props.employee.newImage ?
     props.employee.newImage.name : 'Upload Image Here'
    email = props.employee.email
    emailHelper = props.emailHelper
    currentEmail = props.component[props.index].email
    currentIsActive = props.component[props.index].is_active  === true ? 'Yes': 'No'
 ...
 currentAdmin = props.component[props.index].is_admin === true ? 'Yes': 'No'
 adminShow =true;
 if(props.employee.image !== null && props.employee.image !== '') {
  image = "http://localhost:8080/" + props.employee.image
...
<form onSubmit= {props.update}>
  ...
  //  xs={12}
   >
  {(props.type ==="Employee" || props.type === "Student") && (
    <React.Fragment>
...
<Grid item xs={12} className={classes.currentInfo}>
  <Typography>Is Administrator: &nbsp;  {currentAdmin}</Typography>
</Grid>
<Grid item xs={12} className={classes.currentInfo}>
    ...
    <TextField
            ...
            {adminShow && (
              ...
              <FormControl>
               ...
               <Grid item container style={{marginTop: "2rem", marginBottom: "4rem"}}>
               <Grid item xs={12} sm ={6} className={classes.radioContainer}>
                   <Typography  color="secondary" className={classes.titleMargin}>Active Status</Typography>
               </Grid>
               <Grid item xs={12} sm ={6} className={classes.radioContainer}>                
               <FormControl>
                         <RadioGroup 
               ...
               {activeShow && (<Grid item xs={12} className={classes.imagePicker}>
<StyledDropZone 
children= {label}
onDrop={props.drop} />
</Grid>)}
          ...
          <div className={classes.buttonContainer}>
            <Button type="submit"  onClick={props.update}disabled={props.nameHelper.length !== 0}className={classes.button} variant="contained" color="secondary">Save Changes</Button>
