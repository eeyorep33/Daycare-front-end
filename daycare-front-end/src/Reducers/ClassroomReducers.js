export const initialState = {
    loading: false, classError: null, classrooms:null
}
...
const classroomReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case "GET_CLASSROOMS_SUCCESS":
        return { ...state, classrooms: action.payload.classrooms, loading: false}
        break;
        ...
        case "EDIT_CLASSROOM_START":
          ...
          case "EDIT_CLASSROOM_ERROR":
            return { ...state, classError: action.error.response.data.message, loading: false}
            break;
        ...
        editClassroom[index] = { ...editClassroom[index], name:action.payload.classroom.name }        
        ...
        break;
            ...
            case "ADD_CLASSROOM_START":
              ...
              case "ADD_CLASSROOM_SUCCESS":
                return { ...state, classrooms: state.classrooms.concat(action.payload.classroom), loading: false}
                break;
