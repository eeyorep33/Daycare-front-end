...
const Login = (props) => {
  ...
  const enter = (event) => {
    if (event.keyCode === 13) {
      props.onLogin(event, { userName: userName, password: password });
    }
  };
  ...
  return (
    <React.Fragment>
        ...
        >
          ...
          <Grid item xs={12}>
            <Button
              ...
              type="submit"
              onClick={(e) => {
                props.onLogin(e, { userName: userName, password: password });
              }}
              variant="contained"
              color="secondary"
      ...
      <div className={classes.signUpLink}>
        <p>
          Don't have an Account? Click <a href="/signup">here</a> to enroll your
          facility.
        </p>
      </div>
    </React.Fragment>
