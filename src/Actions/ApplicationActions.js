...
export const editUser = (id, token, user) => {
  return (dispatch) => {
    ...
    axios
      .put(process.env.REACT_APP_API_URL + 'userProfile/' + id, user, {
        headers: {
          Authorization: 'Bearer ' + token,
        },
      })
...
export const resetPassword = (passwords, token, user) => {
  return (dispatch) => {
    ...
    return axios
      .put(process.env.REACT_APP_API_URL + 'reset/password', passwords, {
        headers: {
...
export const editFacility = (facility, id, token, user) => {
  return (dispatch) => {
    ...
    axios
      .put(process.env.REACT_APP_API_URL + 'facility/' + id, facility, {
        headers: {
          Authorization: 'Bearer ' + token,
          uid: user,
        },
...
export const editAnnouncements = (token, announcement, id) => {
  return (dispatch) => {
    ...
    axios
      .put(process.env.REACT_APP_API_URL + 'announcement/' + id
      , announcement, {
        headers: {
          Authorization: 'Bearer ' + token,
        },
...
export const addAnnouncement = (token, announcement, user) => {
  return (dispatch) => {
    ...
    axios
      .post(process.env.REACT_APP_API_URL + 'announcement'
      ,announcement, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + token,
